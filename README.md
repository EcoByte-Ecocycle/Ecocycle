...
FrontEnd
 OS : Windows 10, MacOS  개발 도구: Javascript
- BackEnd
 서버 : AWS, Java, SpringBoot  개발 도구 : Intellij
 DB : MySQL
- AI
 모델링 : python, jupiternotebook , Pytorch라이브러리, Selenium패키지  클라우드 : google(학습data), aws-datasync(사용자data)
 모델서빙 : BentoML, Yatai
